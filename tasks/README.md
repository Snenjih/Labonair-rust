...
The current active task queue is [`rework/`](rework/). Phase 1 is complete and
the first two Phase 2 tasks are complete. The current task is
`R02-003-project-entry-and-workspace-transitions.md`.
