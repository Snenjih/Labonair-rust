...
pub fn all_fields() -> Vec<AnyField> {
    ...
    vec![
        ...
        field!(
            ai.ai_terminal_context_lines,
            "aiTerminalContextLines",
            Int { min: 0, max: 2000, step: 50 },
        ...
        field!(
            ai.ai_temperature,
            "aiTemperature",
            Float { min_centi: 0, max_centi: 200, step_centi: 5 },
            "Temperature",
            "Model sampling temperature."
        ),
        field!(
            ai.ai_warn_destructive_commands,
        ...
        field!(
            ai.ai_notify_on_headless_command,
        ...
        field!(
            ai.ai_shell_max_timeout_secs,
            "aiShellMaxTimeoutSecs",
            Int { min: 30, max: 1800, step: 30 },
            "Max command timeout",
            "Kill an agent shell command after this long (s)."
        ),
        field!(
            ai.ai_shell_max_output_kb,
            "aiShellMaxOutputKb",
            Int { min: 64, max: 2048, step: 64 },
            "Max command output",
            "Truncate captured command output past this size (KB)."
        ),
        field!(
            ai.default_model_id,
            "defaultModelId",
        ...
        field!(
            ai.lmstudio_base_url,
            "lmstudioBaseURL",
            Text,
            "LM Studio base URL",
            "Endpoint for the local LM Studio server."
        ),
        field!(
            ai.lmstudio_chat_model_id,
            "lmstudioChatModelId",
            Text,
            "LM Studio chat model id",
            "Model id served by the local LM Studio server."
        ),
        field!(
            ...
            "Endpoint for an OpenAI-compatible server."
        ),
        field!(
            ai.openai_compatible_model_id,
        ...
        field!(
            ...
            Text,
            "MLX base URL",
            "Endpoint for the local MLX server."
        ),
        field!(
            ai.mlx_chat_model_id,
            "mlxChatModelId",
            Text,
            "MLX chat model id",
            "Model id served by the local MLX server."
        ),
        field!(
            ai.ollama_base_url,
            "ollamaBaseURL",
        ...
        field!(
            ai.ollama_chat_model_id,
            "ollamaChatModelId",
            Text,
            "Ollama chat model id",
            "Model id served by the local Ollama server."
        ),
        // ── mcp ──────────────────────────────────────────────────────────
        field!(
            mcp.bridge_enabled,
