...
fn workspace_from(p: &Preferences) -> WorkspaceContent {
    WorkspaceContent {
        ...
        bookmarks_enabled: Some(p.bookmarks_enabled),
        bookmarks_action_new_terminal: Some(p.bookmarks_action_new_terminal),
        bookmarks_action_current_terminal: Some(p.bookmarks_action_current_terminal),
        bookmarks_action_current_sftp: Some(p.bookmarks_action_current_sftp),
        bookmarks_action_new_sftp: Some(p.bookmarks_action_new_sftp),
        bookmarks_primary_click_behavior: Some(p.bookmarks_primary_click_behavior.clone()),
        bookmarks_show_badge: Some(p.bookmarks_show_badge),
