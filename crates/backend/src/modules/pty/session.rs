...
pub struct Session {
    ...
    /// pane's own `crate::events::EventChannel<PtyEvent>`. Raw bytes (not a repaired `String`
    ...
    thread::Builder::new()
        ...
        .spawn(move || {
            ...
            loop {
                ...
                // NOTE on base64: Tauri v2 `crate::events::EventChannel<T>` serializes via JSON;
