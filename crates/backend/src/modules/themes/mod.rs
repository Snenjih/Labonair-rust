...
pub async fn themes_get_all(app: crate::App) -> Result<Vec<ThemeMeta>, String> {
...
pub async fn theme_import(app: crate::App, source_path: String) -> Result<ThemeMeta, String> {
...
pub async fn theme_export(app: crate::App, id: String, dest_path: String) -> Result<(), String> {
...
pub async fn theme_create(app: crate::App, name: String) -> Result<(ThemeMeta, String), String> {
...
pub async fn themes_get_dir(app: crate::App) -> Result<String, String> {
...
pub async fn theme_download(app: crate::App, url: String) -> Result<ThemeMeta, String> {
    let client = reqwest::Client::builder()
    ...
    let theme: Theme =
        serde_json::from_str(&raw_json).map_err(|e| format!("Invalid theme JSON: {}", e))?;
    theme.validate()?;
