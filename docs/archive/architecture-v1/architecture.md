...
[`bericht-workflow-rework.md`](../../reports/bericht-workflow-rework.md).
...
The generated crate-graph image from the original migration is not retained;
the current graph is produced by `scripts/gen-crate-graph.sh`.
