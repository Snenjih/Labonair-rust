...
| Explorer | Redesign | `explorer` | `labonair-panel-explorer` | `labonair-panel-explorer` | `labonair-filesystem` | Explorer dock panel | Canonical Explorer capability/UI crate; backend edge removed, workspace shim remains |
